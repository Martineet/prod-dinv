        ...
        <div className="wib-content">
          ...
          <nav className="wib-toc" aria-label="Table of contents">
            ...
            <ol className="wib-toc-list">
              <li><a href="#origins">3.1 — Origins of a revolutionary idea</a></li>
              <li><a href="#open-source">3.2 — Open source philosophy and Nakamoto&apos;s legacy</a></li>
              <li><a href="#blockchain">3.3 — Blockchain</a></li>
              <li><a href="#validation">3.4 — The validation process and cryptographic security</a></li>
              <li><a href="#scarcity">3.5 — Digital scarcity and monetary sovereignty</a></li>
              <li><a href="#storage">3.6 — How to store your Bitcoin</a></li>
              <li><a href="#buy">3.7 — Where to buy Bitcoin</a></li>
              <li><a href="#price">3.8 — How is the price of Bitcoin determined?</a></li>
              <li><a href="#religion">3.9 — Bitcoin as the first true religion of the 21st century</a></li>
            </ol>
          </nav>
          ...
          <section className="wib-section" id="religion">
            ...
            <p className="wib-paragraph">
              <strong>It has a sacred text.</strong> The Bitcoin White Paper — nine pages long — is
              still passed around in printed form like scripture. You can read it here:{' '}
          ...
          <section className="wib-section wib-sources" id="sources">
            ...
            <ul className="wib-sources-list">
              ...
              <li>
                ...
                — A clear technical explanation of the blockchain data structure.
              </li>
              <li>
