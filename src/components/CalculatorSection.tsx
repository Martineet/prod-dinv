...
export function CalculatorSection({ btcPrice }: CalculatorSectionProps) {
  ...
  return (
    <div className="calculator-panel">
      <h2 className="section-title large">{`${MONEY_BAG} `}{t('calculator_title')}{` ${CALCULATOR}`}</h2>
      <div className="calculator-card">
        <div className="calc-grid">
          <div className="calc-row">
            <label>{t('calculator_current_price')}</label>
            <input type="text" value={displayCurrent} readOnly className="input-readonly" />
          </div>
          <div className="calc-row">
            <label>{t('calculator_growth_rate')}</label>
            <input
              type="number"
              value={growthRate}
          ...
          <div className="calc-row">
            <label>{t('calculator_investment_amount')}</label>
            <input
              type="number"
              value={investment}
          ...
          <div className="calc-row">
            <label>{t('calculator_expected_price')}</label>
            <input
              type="number"
        ...
        <div className="calc-result">
          <div className="result-label">{t('calculator_expected_value')}</div>
